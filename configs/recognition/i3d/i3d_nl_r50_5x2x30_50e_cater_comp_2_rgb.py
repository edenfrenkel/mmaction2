...
model = dict(
    ...
    cls_head=dict(
        ...
        consensus=dict(type='LSTMConsensus',
                       input_size=2048, hidden_size=512, num_layers=2),
...
train_pipeline = [
    ...
    dict(type='SequentialSampleFrames', clip_len=5, frame_interval=2, num_clips=30),
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        eval_config={'filename': '../comp_2_eval.json', 'is_comp': True},
...
log_level = 'INFO'
work_dir = './work_dirs/i3d_nl_r50_5x2x30_50e_cater_comp_2_rgb/'
load_from = None
resume_from = None
workflow = [('train', 1)]
